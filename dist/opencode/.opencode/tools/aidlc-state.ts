...
function migrateLegacyState(value: unknown, workflowId: string = randomUUID()): WorkflowState {
  ...
  return validateWorkflowState({
    schema_version: 2,
    version: typeof value.version === "string" && value.version ? value.version : "2.1.3",
...
export function createInitialState(scope: string, version = "2.1.3", workflowId: string = randomUUID()): WorkflowState {
